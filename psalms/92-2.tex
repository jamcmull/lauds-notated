% f3
% 2D
% 1. Dó(e)mi(f)nus(h) re(h)gná(h)vit,(h) de(h)có(h)rem(h) ind(h)<b>ú</b>(i)tus(hr) est:(h.) *(:) ind(h)ú(h)tus(h) est(h) Dó(h)mi(h)nus(h) for(h)ti(h)tú(h)di(h)nem,(h) et(h) <i>præ</i>(g)<b>cín</b>(e)xit(fr) se.(f.) (::)
