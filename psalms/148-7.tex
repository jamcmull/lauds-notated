% c3
% 7a
% 1. Lau(hg)dá(hi)te(i) Dó(i)mi(i)<b>num</b>(k) de(j) <b>cæ</b>(i)lis:(j.) *(:) lau(i)dá(i)te(i) e(i)um(i) <b>in</b>(j) ex(i)<b>cél</b>(h)sis.(gf..) <i>Flex:</i>(::)  vír(i)gi(h)nes, +(h. i i i  ::)
% 7b
% 1. Lau(hg)dá(hi)te(i) Dó(i)mi(i)<b>num</b>(k) de(j) <b>cæ</b>(i)lis:(j.) *(:) lau(i)dá(i)te(i) e(i)um(i) <b>in</b>(j) ex(i)<b>cél</b>(h)sis.(g.) <i>Flex:</i>(::)  vír(i)gi(h)nes, +(h. i i i  ::)
% 7c
% 1. Lau(hg)dá(hi)te(i) Dó(i)mi(i)<b>num</b>(k) de(j) <b>cæ</b>(i)lis:(j.) *(:) lau(i)dá(i)te(i) e(i)um(i) <b>in</b>(j) ex(i)<b>cél</b>(h)sis.(gh..) <i>Flex:</i>(::)  vír(i)gi(h)nes, +(h. i i i  ::)
% 7c2
...
% 7d
% 1. Lau(hg)dá(hi)te(i) Dó(i)mi(i)<b>num</b>(k) de(j) <b>cæ</b>(i)lis:(j.) *(:) lau(i)dá(i)te(i) e(i)um(i) <b>in</b>(j) ex(i)<b>cél</b>(h)sis.(gi..) <i>Flex:</i>(::)  vír(i)gi(h)nes, +(h. i i i  ::)
