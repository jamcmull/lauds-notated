% c4
% 6F
% 1. Be(f)ne(gh)díc(h)tus(h) Dó(h)mi(h)nus,(h) De(h)<i>us</i>(g) <b>Is</b>(h)ra(fr)ël:(f.) *(:) qui(h)a(h) vi(h)si(h)tá(h)vit,(h) et(h) fe(h)cit(h) red(h)emp(h)ti(h)ó(h)nem(h) <i>ple</i>(f)<i>bis</i>(gh) <b>su</b>(g fr)æ:(f.) (::)
