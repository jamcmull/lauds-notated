% c4
% 8G
% 1. Mi(g)se(h)ré(j)re(j) me(j)i(j) <b>De</b>(k jr)us,(j.) *(:) se(j)cún(j)dum(j) ma(j)gnam(j) mi(j)se(j)ri(j)cór(j)<i>di</i>(i)<i>am</i>(j) <b>tu</b>(h gr)am.(g.) (::)
% 8G*
% 1. Mi(g)se(h)ré(j)re(j) me(j)i(j) <b>De</b>(k jr)us,(j.) *(:) se(j)cún(j)dum(j) ma(j)gnam(j) mi(j)se(j)ri(j)cór(j)<i>di</i>(i)<i>am</i>(j) <b>tu</b>(h gr)am.(gh..) (::)
% 8c
% 1. Mi(g)se(h)ré(j)re(j) me(j)i(j) <b>De</b>(k jr)us,(j.) *(:) se(j)cún(j)dum(j) ma(j)gnam(j) mi(j)se(j)ri(j)cór(j)<i>di</i>(h)<i>am</i>(j) <b>tu</b>(k jr)am.(j.) (::)
