% c4
% 3b antiquo
% 1. Mi(g)se(hi)ré(i)re(i) <b>me</b>(k)i(j) <b>De</b>(ih)us,(j.) *(:) se(i)cún(i)dum(i) ma(i)gnam(i) mi(i)se(i)ri(i)<b>cór</b>(j)di(h)am(h) <b>tu</b>(j)am.(i.) (::)
% 3a antiquo
% 1. Mi(g)se(hi)ré(i)re(i) <b>me</b>(k)i(j) <b>De</b>(ih)us,(j.) *(:) se(i)cún(i)dum(i) ma(i)gnam(i) mi(i)se(i)ri(i)<b>cór</b>(j)di(h)am(h) <b>tu</b>(j)am.(ih..) (::)
% 3a2 antiquo
% 1. Mi(g)se(hi)ré(i)re(i) <b>me</b>(k)i(j) <b>De</b>(ih)us,(j.) *(:) se(i)cún(i)dum(i) ma(i)gnam(i) mi(i)se(i)ri(i)<b>cór</b>(j)di(h)am(hi) <b>tu</b>(h)am.(gh..) (::)
% 3g antiquo
% 1. Mi(g)se(hi)ré(i)re(i) <b>me</b>(k)i(j) <b>De</b>(ih)us,(j.) *(:) se(i)cún(i)dum(i) ma(i)gnam(i) mi(i)se(i)ri(i)<b>cór</b>(j)di(h)am(hi) <b>tu</b>(h)am.(g.) (::)
