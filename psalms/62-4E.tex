% c4
% 4E
% 1. De(h)us,(gh hr) <i>De</i>(g)<i>us</i>(h) <b>me</b>(i hr)us,(h.) *(:) ad(h) te(h) <i>de</i>(g) <i>lu</i>(h)<i>ce</i>(ih) <b>ví</b>(gr[ocb:1{])<b>gi</b>(gf[ocb:0}])lo.(e.) <i>Flex:</i>(::)  in(h)a(h)quó(h)sa: +(g. h h h  ::)
