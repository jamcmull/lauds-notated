% c4
% 1D
% 1. De(f)us,(gh) <b>De</b>(ixi)us(h) <b>me</b>(g)us,(h.) *(:) ad(h) te(h) de(h) <i>lu</i>(g)<i>ce</i>(f) <b>ví</b>(gh)gi(g)lo.(gvFED.) <i>Flex:</i>(::) in(h)a(h)quó(h)sa: +(g. h h h  ::)
% 1D-
% 1. De(f)us,(gh) <b>De</b>(ixi)us(h) <b>me</b>(g)us,(h.) *(:) ad(h) te(h) de(h) <i>lu</i>(g)<i>ce</i>(f) <b>ví</b>(g)gi(g)lo.(gvFED.) <i>Flex:</i>(::) in(h)a(h)quó(h)sa: +(g. h h h  ::)
% 1f
% 1. De(f)us,(gh) <b>De</b>(ixi)us(h) <b>me</b>(g)us,(h.) *(:) ad(h) te(h) de(h) <i>lu</i>(g)<i>ce</i>(f) <b>ví</b>(gh)gi(g)lo.(gf..) <i>Flex:</i>(::) in(h)a(h)quó(h)sa: +(g. h h h  ::)
% 1g
% 1. De(f)us,(gh) <b>De</b>(ixi)us(h) <b>me</b>(g)us,(h.) *(:) ad(h) te(h) de(h) <i>lu</i>(g)<i>ce</i>(f) <b>ví</b>(gh)gi(g)lo.(g.) <i>Flex:</i>(::) in(h)a(h)quó(h)sa: +(g. h h h  ::)
% 1g2
% 1. De(f)us,(gh) <b>De</b>(ixi)us(h) <b>me</b>(g)us,(h.) *(:) ad(h) te(h) de(h) <i>lu</i>(g)<i>ce</i>(f) <b>ví</b>(g)gi(g)lo.(ghg.) <i>Flex:</i>(::) in(h)a(h)quó(h)sa: +(g. h h h  ::)
% 1g3
% 1. De(f)us,(gh) <b>De</b>(ixi)us(h) <b>me</b>(g)us,(h.) *(:) ad(h) te(h) de(h) <i>lu</i>(g)<i>ce</i>(f) <b>ví</b>(g)gi(g)lo.(g.) <i>Flex:</i>(::) in(h)a(h)quó(h)sa: +(g. h h h  ::)
% 1a
% 1. De(f)us,(gh) <b>De</b>(ixi)us(h) <b>me</b>(g)us,(h.) *(:) ad(h) te(h) de(h) <i>lu</i>(g)<i>ce</i>(f) <b>ví</b>(g)gi(h)lo.(h.) <i>Flex:</i>(::) in(h)a(h)quó(h)sa: +(g. h h h  ::)
% 1a2
% 1. De(f)us,(gh) <b>De</b>(ixi)us(h) <b>me</b>(g)us,(h.) *(:) ad(h) te(h) de(h) <i>lu</i>(g)<i>ce</i>(f) <b>ví</b>(g)gi(g)lo.(gh..) <i>Flex:</i>(::) in(h)a(h)quó(h)sa: +(g. h h h  ::)
% 1a3
% 1. De(f)us,(gh) <b>De</b>(ixi)us(h) <b>me</b>(g)us,(h.) *(:) ad(h) te(h) de(h) <i>lu</i>(g)<i>ce</i>(f) <b>ví</b>(gh)gi(g)lo.(gh..) <i>Flex:</i>(::) in(h)a(h)quó(h)sa: +(g. h h h  ::)
