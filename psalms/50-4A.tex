% c3
% 4A
% 1. Mi(i)se(hi)ré(i)re(i) <i>me</i>(h)<i>i</i>(i) <b>De</b>(j ir)us,(i.) *(:) se(i)cún(i)dum(i) ma(i)gnam(i) mi(i)se(i)ri(i)<i>cór</i>(h)<i>di</i>(i)<i>am</i>(j) <b>tu</b>(h fr)am.(f.) (::)
% 4A*
% 1. Mi(i)se(hi)ré(i)re(i) <i>me</i>(h)<i>i</i>(i) <b>De</b>(j ir)us,(i.) *(:) se(i)cún(i)dum(i) ma(i)gnam(i) mi(i)se(i)ri(i)<i>cór</i>(h)<i>di</i>(i)<i>am</i>(j) <b>tu</b>(h fr)am.(fg..) (::)
