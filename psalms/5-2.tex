% f3
% 2D
% 1. Ver(e)ba(f) me(h)a(h) áu(h)ri(h)bus(h) pér(h)ci(h)pe,(h) <b>Dó</b>(i)mi(hr)ne,(h.) *(:) in(h)tél(h)li(h)ge(h) cla(h)mó(h)<i>rem</i>(g) <b>me</b>(e fr)um.(f.) <i>Flex:</i>(::)  e(h)ó(h)rum, +(f. h h h  ::)
