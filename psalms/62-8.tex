% c4
% 8G
% 1. De(g)us,(h) De(j)us(j) <b>me</b>(k jr)us,(j.) *(:) ad(j) te(j) de(j) <i>lu</i>(i)<i>ce</i>(j) <b>ví</b>(h)gi(gr)lo.(g.) <i>Flex:</i>(::)  in(j)a(j)quó(j)sa: +(h. j j j  ::)
% 8G*
% 1. De(g)us,(h) De(j)us(j) <b>me</b>(k jr)us,(j.) *(:) ad(j) te(j) de(j) <i>lu</i>(i)<i>ce</i>(j) <b>ví</b>(h)gi(gr)lo.(gh..) <i>Flex:</i>(::)  in(j)a(j)quó(j)sa: +(h. j j j  ::)
% 8c
% 1. De(g)us,(h) De(j)us(j) <b>me</b>(k jr)us,(j.) *(:) ad(j) te(j) de(j) <i>lu</i>(h)<i>ce</i>(j) <b>ví</b>(k)gi(jr)lo.(j.) <i>Flex:</i>(::)  in(j)a(j)quó(j)sa: +(h. j j j  ::)
