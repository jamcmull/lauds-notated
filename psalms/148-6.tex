% c4
% 6F
% 1. Lau(f)dá(gh)te(h) Dó(h)mi(h)num(h) <i>de</i>(g) <b>cæ</b>(h fr)lis:(f.) *(:) lau(h)dá(h)te(h) e(h)um(h) <i>in</i>(f) <i>ex</i>(gh)<b>cél</b>(g fr)sis.(f.) <i>Flex:</i>(::)  vír(h)gi(g)nes, +(g. h h h  ::)
