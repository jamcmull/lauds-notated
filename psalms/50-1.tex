% c4
% 1f
% 1. Mi(f)se(gh)ré(h)re(h) <b>me</b>(ixi)i(h) <b>De</b>(g)us,(h.) *(:) se(h)cún(h)dum(h) ma(h)gnam(h) mi(h)se(h)ri(h)cór(h)<i>di</i>(g)<i>am</i>(f) <b>tu</b>(gh)am.(gf..) (::)
% 1g
% 1. Mi(f)se(gh)ré(h)re(h) <b>me</b>(ixi)i(h) <b>De</b>(g)us,(h.) *(:) se(h)cún(h)dum(h) ma(h)gnam(h) mi(h)se(h)ri(h)cór(h)<i>di</i>(g)<i>am</i>(f) <b>tu</b>(gh)am.(g.) (::)
% 1g2
% 1. Mi(f)se(gh)ré(h)re(h) <b>me</b>(ixi)i(h) <b>De</b>(g)us,(h.) *(:) se(h)cún(h)dum(h) ma(h)gnam(h) mi(h)se(h)ri(h)cór(h)<i>di</i>(g)<i>am</i>(f) <b>tu</b>(g)am.(ghg.) (::)
% 1a
% 1. Mi(f)se(gh)ré(h)re(h) <b>me</b>(ixi)i(h) <b>De</b>(g)us,(h.) *(:) se(h)cún(h)dum(h) ma(h)gnam(h) mi(h)se(h)ri(h)cór(h)<i>di</i>(g)<i>am</i>(f) <b>tu</b>(g)am.(h.) (::)
