% c4
% 3b antiquo
% 1. Lau(g)dá(hi)te(i) Dó(i)mi(i)<b>num</b>(k jr) de(j jr[ocb:1{]) <b>cæ</b>(ih[ocb:0}])lis:(j.) *(:) lau(i)dá(i)te(i) e(i)um(i) <b>in</b>(j hr) ex(h)<b>cél</b>(j jr)sis.(i.) <i>Flex:</i>(::)  vír(i)gi(h)nes, +(h. i i i  ::)
% 3a antiquo
% 1. Lau(g)dá(hi)te(i) Dó(i)mi(i)<b>num</b>(k jr) de(j jr[ocb:1{]) <b>cæ</b>(ih[ocb:0}])lis:(j.) *(:) lau(i)dá(i)te(i) e(i)um(i) <b>in</b>(j hr) ex(h)<b>cél</b>(j jr)sis.(ih..) <i>Flex:</i>(::)  vír(i)gi(h)nes, +(h. i i i  ::)
% 3a2 antiquo
% 1. Lau(g)dá(hi)te(i) Dó(i)mi(i)<b>num</b>(k jr) de(j jr[ocb:1{]) <b>cæ</b>(ih[ocb:0}])lis:(j.) *(:) lau(i)dá(i)te(i) e(i)um(i) <b>in</b>(j hr) ex(hi)<b>cél</b>(h gr)sis.(gh..) <i>Flex:</i>(::)  vír(i)gi(h)nes, +(h. i i i  ::)
% 3g antiquo
% 1. Lau(g)dá(hi)te(i) Dó(i)mi(i)<b>num</b>(k jr) de(j jr[ocb:1{]) <b>cæ</b>(ih[ocb:0}])lis:(j.) *(:) lau(i)dá(i)te(i) e(i)um(i) <b>in</b>(j hr) ex(hi)<b>cél</b>(h gr)sis.(g.) <i>Flex:</i>(::)  vír(i)gi(h)nes, +(h. i i i  ::)
