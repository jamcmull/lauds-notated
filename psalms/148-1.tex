% c4
% 1D
% 1. Lau(f)dá(gh)te(h) Dó(h)mi(h)<b>num</b>(ixi hr) de(h) <b>cæ</b>(g hr)lis:(h.) *(:) lau(h)dá(h)te(h) e(h)um(h) <i>in</i>(g) <i>ex</i>(f)<b>cél</b>(gh gr)sis.(gvFED.) <i>Flex:</i>(::) vír(h)gi(g)nes, +(g. h h h  ::)
% 1D-
% 1. Lau(f)dá(gh)te(h) Dó(h)mi(h)<b>num</b>(ixi hr) de(h) <b>cæ</b>(g hr)lis:(h.) *(:) lau(h)dá(h)te(h) e(h)um(h) <i>in</i>(g) <i>ex</i>(f)<b>cél</b>(g gr)sis.(gvFED.) <i>Flex:</i>(::) vír(h)gi(g)nes, +(g. h h h  ::)
% 1f
% 1. Lau(f)dá(gh)te(h) Dó(h)mi(h)<b>num</b>(ixi hr) de(h) <b>cæ</b>(g hr)lis:(h.) *(:) lau(h)dá(h)te(h) e(h)um(h) <i>in</i>(g) <i>ex</i>(f)<b>cél</b>(gh gr)sis.(gf..) <i>Flex:</i>(::) vír(h)gi(g)nes, +(g. h h h  ::)
% 1g
% 1. Lau(f)dá(gh)te(h) Dó(h)mi(h)<b>num</b>(ixi hr) de(h) <b>cæ</b>(g hr)lis:(h.) *(:) lau(h)dá(h)te(h) e(h)um(h) <i>in</i>(g) <i>ex</i>(f)<b>cél</b>(gh gr)sis.(g.) <i>Flex:</i>(::) vír(h)gi(g)nes, +(g. h h h  ::)
% 1g2
% 1. Lau(f)dá(gh)te(h) Dó(h)mi(h)<b>num</b>(ixi hr) de(h) <b>cæ</b>(g hr)lis:(h.) *(:) lau(h)dá(h)te(h) e(h)um(h) <i>in</i>(g) <i>ex</i>(f)<b>cél</b>(g gr)sis.(ghg.) <i>Flex:</i>(::) vír(h)gi(g)nes, +(g. h h h  ::)
% 1g3
% 1. Lau(f)dá(gh)te(h) Dó(h)mi(h)<b>num</b>(ixi hr) de(h) <b>cæ</b>(g hr)lis:(h.) *(:) lau(h)dá(h)te(h) e(h)um(h) <i>in</i>(g) <i>ex</i>(f)<b>cél</b>(g gr)sis.(g.) <i>Flex:</i>(::) vír(h)gi(g)nes, +(g. h h h  ::)
% 1a
% 1. Lau(f)dá(gh)te(h) Dó(h)mi(h)<b>num</b>(ixi hr) de(h) <b>cæ</b>(g hr)lis:(h.) *(:) lau(h)dá(h)te(h) e(h)um(h) <i>in</i>(g) <i>ex</i>(f)<b>cél</b>(g hr)sis.(h.) <i>Flex:</i>(::) vír(h)gi(g)nes, +(g. h h h  ::)
% 1a2
% 1. Lau(f)dá(gh)te(h) Dó(h)mi(h)<b>num</b>(ixi hr) de(h) <b>cæ</b>(g hr)lis:(h.) *(:) lau(h)dá(h)te(h) e(h)um(h) <i>in</i>(g) <i>ex</i>(f)<b>cél</b>(g gr)sis.(gh..) <i>Flex:</i>(::) vír(h)gi(g)nes, +(g. h h h  ::)
% 1a3
% 1. Lau(f)dá(gh)te(h) Dó(h)mi(h)<b>num</b>(ixi hr) de(h) <b>cæ</b>(g hr)lis:(h.) *(:) lau(h)dá(h)te(h) e(h)um(h) <i>in</i>(g) <i>ex</i>(f)<b>cél</b>(gh gr)sis.(gh..) <i>Flex:</i>(::) vír(h)gi(g)nes, +(g. h h h  ::)
