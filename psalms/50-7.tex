% c3
% 7a
% 1. Mi(hg)se(hi)ré(i)re(i) <b>me</b>(k)i(j) <b>De</b>(i)us,(j.) *(:) se(i)cún(i)dum(i) ma(i)gnam(i) mi(i)se(i)ri(i)<b>cór</b>(j)di(i)am(i) <b>tu</b>(h)am.(gf..) (::)
% 7b
% 1. Mi(hg)se(hi)ré(i)re(i) <b>me</b>(k)i(j) <b>De</b>(i)us,(j.) *(:) se(i)cún(i)dum(i) ma(i)gnam(i) mi(i)se(i)ri(i)<b>cór</b>(j)di(i)am(i) <b>tu</b>(h)am.(g.) (::)
% 7c
% 1. Mi(hg)se(hi)ré(i)re(i) <b>me</b>(k)i(j) <b>De</b>(i)us,(j.) *(:) se(i)cún(i)dum(i) ma(i)gnam(i) mi(i)se(i)ri(i)<b>cór</b>(j)di(i)am(i) <b>tu</b>(h)am.(gh..) (::)
% 7c2
% 1. Mi(hg)se(hi)ré(i)re(i) <b>me</b>(k)i(j) <b>De</b>(i)us,(j.) *(:) se(i)cún(i)dum(i) ma(i)gnam(i) mi(i)se(i)ri(i)<b>cór</b>(j)di(i)am(i) <b>tu</b>(h)am.(ih..) (::)
% 7d
% 1. Mi(hg)se(hi)ré(i)re(i) <b>me</b>(k)i(j) <b>De</b>(i)us,(j.) *(:) se(i)cún(i)dum(i) ma(i)gnam(i) mi(i)se(i)ri(i)<b>cór</b>(j)di(i)am(i) <b>tu</b>(h)am.(gi..) (::)
