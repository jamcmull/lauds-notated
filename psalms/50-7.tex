% c3
% 7a
% 1. Mi(hg)se(hi)ré(i)re(i) <b>me</b>(k jr)i(j) <b>De</b>(i jr)us,(j.) *(:) se(i)cún(i)dum(i) ma(i)gnam(i) mi(i)se(i)ri(i)<b>cór</b>(j)di(ir)am(i) <b>tu</b>(h hr)am.(gf..) (::)
% 7b
% 1. Mi(hg)se(hi)ré(i)re(i) <b>me</b>(k jr)i(j) <b>De</b>(i jr)us,(j.) *(:) se(i)cún(i)dum(i) ma(i)gnam(i) mi(i)se(i)ri(i)<b>cór</b>(j)di(ir)am(i) <b>tu</b>(h hr)am.(g.) (::)
% 7c
% 1. Mi(hg)se(hi)ré(i)re(i) <b>me</b>(k jr)i(j) <b>De</b>(i jr)us,(j.) *(:) se(i)cún(i)dum(i) ma(i)gnam(i) mi(i)se(i)ri(i)<b>cór</b>(j)di(ir)am(i) <b>tu</b>(h hr)am.(gh..) (::)
% 7c2
% 1. Mi(hg)se(hi)ré(i)re(i) <b>me</b>(k jr)i(j) <b>De</b>(i jr)us,(j.) *(:) se(i)cún(i)dum(i) ma(i)gnam(i) mi(i)se(i)ri(i)<b>cór</b>(j)di(ir)am(i) <b>tu</b>(h hr)am.(ih..) (::)
% 7d
% 1. Mi(hg)se(hi)ré(i)re(i) <b>me</b>(k jr)i(j) <b>De</b>(i jr)us,(j.) *(:) se(i)cún(i)dum(i) ma(i)gnam(i) mi(i)se(i)ri(i)<b>cór</b>(j)di(ir)am(i) <b>tu</b>(h hr)am.(gi..) (::)
