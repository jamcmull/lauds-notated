% c4
% 1. Ju(f)bi(gh)lá(h)te(h) De(h)o,(h) <b>om</b>(ixi)nis(h) <b>ter</b>(g)ra:(h.) *(:) ser(h)ví(h)te(h) Dó(h)mi(h)no(h) <i>in</i>(g) <i>læ</i>(f)<b>tí</b>(g)ti(g)a.(ghg.) <i>Flex:</i>(::) pás(h)cu(h)æ(h) e(h)jus: +(g. h h h  ::)
