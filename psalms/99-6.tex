% c4
% 6F
% 1. Ju(f)bi(gh)lá(h)te(h) De(h)o,(h) om(h)<i>nis</i>(g) <b>ter</b>(h fr)ra:(f.) *(:) ser(h)ví(h)te(h) Dó(h)mi(h)no(h) <i>in</i>(f) <i>læ</i>(gh)<b>tí</b>(g)ti(fr)a.(f.) <i>Flex:</i>(::)  pás(h)cu(h)æ(h) e(h)jus: + (g. h h h  ::)
