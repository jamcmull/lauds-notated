...
% 1a3
% 1. Be(f)ne(gh)dí(h)ci(h)te,(h) óm(h)ni(h)a(h) ó(h)pe(h)ra(h) <b>Dó</b>(ixi)mi(h)ni,(h) <b>Dó</b>(g)mi(h)no:(h.) *(:) lau(h)dá(h)te(h) et(h) su(h)per(h)ex(h)al(h)tá(h)te(h) e(h)<i>um</i>(g) <i>in</i>(f) <b>s<sp>'ae</sp></b>(gh)cu(g)la.(gh..) (::)
